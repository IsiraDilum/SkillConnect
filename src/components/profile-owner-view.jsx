        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mb-6">
              {/* Cover Image */}
              <div className="h-40 bg-gradient-to-r from-blue-400 to-blue-500 relative">
                <button className="absolute bottom-3 right-3 p-2 bg-white rounded-full shadow hover:bg-gray-100">
                  ...
                  <div className="flex-1">
                    <div className="-mt-20 mb-6 inline-block relative z-10">
                      <div className="w-32 h-32 rounded-full border-4 border-white bg-blue-500 overflow-hidden flex items-center justify-center shadow-lg">
                        <img src="/user-profile-illustration.png" alt="Profile" className="w-full h-full object-cover" />
                      </div>
                    </div>
          ...
          <div className="w-full lg:w-80 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              ...
              <div className="border-t pt-4">
                <p className="text-xs font-semibold mb-2">Add Feedback</p>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              ...
              <div className="space-y-4">
                ...
                <SimilarProfile name="Chris Brown" role="Head of Product Mgmt" />
                <SimilarProfile name="Dana Lee" role="Chief Usability Officer" />
                <SimilarProfile name="Pat Kim" role="Director of User Exp" />
              </div>
            </div>
          </div>
        </div>
...
function SimilarProfile({ name, role }) {
  return (
    <div className="flex flex-col gap-2 border-b border-gray-100 pb-2 last:border-0">
